      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 mb-8 md:mb-12">
          ...
          <p>
            ...
            ullam iure ratione officia. Corrupti voluptatibus ad vitae adipisci
            asperiores maiores hic explicabo provident. Accusamus amet a,
            tempora asperiores quae expedita!
          </p>
        </div>
...
const data = [
  ...
  { title: "55+", description: "MILLION EUROS IN REVENUE" },
  { title: "30", description: "EMPLOYEES" },
];
